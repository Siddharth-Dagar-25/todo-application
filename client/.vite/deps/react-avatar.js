...
function _isNativeReflectConstruct() {
  if (typeof Reflect === "undefined" || !import_construct.default)
    return false;
  if (import_construct.default.sham)
    return false;
  ...
  _createClass(ConfigProvider2, [{
    ...
    value: function _getContext() {
      ...
      contextKeys.forEach(function(key) {
        if (typeof _this.props[key] !== "undefined")
          context[key] = _this.props[key];
      });
      return context;
    }
  }, {
...
function _isNativeReflectConstruct2() {
  if (typeof Reflect === "undefined" || !import_construct2.default)
    return false;
  if (import_construct2.default.sham)
    return false;
  if (typeof Proxy === "function")
    return true;
  try {
...
function _isNativeReflectConstruct3() {
  if (typeof Reflect === "undefined" || !import_construct3.default)
    return false;
  if (import_construct3.default.sham)
    return false;
  if (typeof Proxy === "function")
    return true;
  try {
...
function _isNativeReflectConstruct5() {
  if (typeof Reflect === "undefined" || !import_construct5.default)
    return false;
  if (import_construct5.default.sham)
    return false;
  if (typeof Proxy === "function")
    return true;
  try {
...
var AvatarText = function(_React$PureComponent) {
  ...
  function AvatarText2() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_scaleTextNode", function(node) {
      ...
      _this._node = node;
      if (!node || !node.parentNode || unstyled || avatar.src || !_this._mounted)
        return;
      ...
      if (textWidth > maxTextWidth)
        spanNode.style.fontSize = "calc(1em * ".concat(maxTextWidth / textWidth, ")");
    });
    return _this;
  }
...
var FacebookSource = _createClass(function FacebookSource2(props) {
  ...
  _defineProperty(this, "get", function(setState) {
    ...
    if (size)
      url += (0, import_concat2.default)(_context = "?width=".concat(size, "&height=")).call(_context, size);
    setState({
      sourceName: "facebook",
      src: url
    });
